...
namespace lib
{
    public partial class return_books : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = con.CreateCommand();
            cmd.CommandType = CommandType.Text;
            cmd.CommandText = " update isse_books set books_return _date='" + dateTimePicker1.Value.ToString() + "' issue_books where id=" + i + "";
           // cmd.EndExecuteNonQuery();
            ...
            MessageBox.Show("books return sccessfully");
            panel3.Visible = true;
